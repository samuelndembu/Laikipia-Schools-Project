...
class Sections extends admin 
{
	...
	*/
	public function add_section() 
	{
		...
		$this->form_validation->set_rules('section_status', 'Status', 'required');
		$this->form_validation->set_rules('section_parent', 'Parent', 'required');
		$this->form_validation->set_rules('section_icon', 'Status', 'trim');
		$this->form_validation->set_rules('section_position', 'Position', 'trim|numeric');
