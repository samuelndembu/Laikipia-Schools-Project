<?php 
	...
	if(!isset($contacts))
	{
		$contacts['email'] = "admin@admin.com";
        $contacts['phone'] = "+254710967675";
        $contacts['facebook'] = "@fb";
        $contacts['twitter'] = "#tweet";
        $contacts['linkedin'] = "linkedin";
        $contacts['company_name'] = "laikipischools";
        $contacts['logo'] = "";
        $contacts['address'] = "laikipia";
        $contacts['city'] = "nanyuki";
        $contacts['post_code'] = "laikipia";
        $contacts['building'] = "laikipia";
        $contacts['floor'] = "";
        $contacts['location'] = "laikipia";
        $contacts['working_weekend'] = "";
        $contacts['working_weekday'] = "";
        $contacts['mission'] = "";
        $contacts['vision'] = "";
        $contacts['motto'] = "";
        $contacts['about'] = "";
