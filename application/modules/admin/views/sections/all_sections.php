			...
			<table class="table table-bordered table-striped table-sm display pb-30">
				<thead>
					<tr>
						...
						<th><a href="'.site_url().'administration/sections/section_parent/'.$order_method.'/'.$page.'">Parent</a></th>
				...
				'
					<tr>
						...
						<td>
							...
							<a href="#user'.$section_id.'" class="btn btn-primary btn-sm" data-toggle="modal" title="Expand '.$section_name.'"><i class="fa fa-plus"></i></a>
					...
					<div class="panel-wrapper collapse in">
						<div class="panel-body">
							...
							<div class="row" style="margin-bottom:20px;">
								<div class="col-lg-12">
									<a href="<?php echo site_url();?>administration/add-section" class="btn btn-warning pull-right">Add Section</a>
								</div>
							</div>
