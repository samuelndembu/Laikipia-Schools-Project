        ...
        <div class="col-md-10">
           ...
           <div class="form-group row">
            ...
            <div class="form-group">
                        <input type="radio" name="status" value="1" <?php echo ($school_status == 'Active') ? 'checked' : '' ?> size="17">Active
                        <input type="radio" name="status" value="0" <?php echo ($school_status == 'Inactive') ? 'checked' : '' ?> size="17">Inactive
                    </div>
                    </div>
