...
class Googlemaps
{
    ...
    public $version = "2";
    public $apikey = "";
    public $map_div_id = "map_canvas";
    public $google_host = "maps.google.com";
    public $map_width = "100%";
    public $map_height = "450px";
    public $center_lat_long = "37.4419, -122.1419";
    public $center_address = "";
    public $sensor = "false";
    public $zoom = 13;
    public $type = "normal"; // normal, satellite, hybrid, earth
    public $controls = array();
    public $hide_controls = false;
    public $icon_image = "";

    public $markers = array();
    public $possible_controls = array("GLargeMapControl3D",
        "GLargeMapControl",
        "GSmallMapControl",
        "GSmallZoomControl3D",
        "GSmallZoomControl",
    ...
    public function get_lat_long_from_address($address = '')
    {
    ...
    public function create_map()
    {
        ...
        switch (strtolower(trim($this->type))) {
            case "satellite":{ $this->type = 'G_SATELLITE_MAP';
                    break;}
            case "earth":{ $this->type = 'G_SATELLITE_3D_MAP';
                    break;}
            case "hybrid":{ $this->type = 'G_HYBRID_MAP';
                    break;}
